...
class Transactions(SQLModel, table=True):
    ...
    transaction_reference: str = Field(sa_column=Column(String, nullable=False, index=True))
    ...
    payment_status: str = Field(
            sa_column=(
                    Column(SQLEnum(OrderPaymentStatusSchema, name="payment_status_enum", create_type=True),
                           nullable=False)))
