...
export default function CarouselBanner({
  ...
  // Boundary Safeguard: If banners get deleted, reset index if out of bounds
  useEffect(() => {
  ...
  if (isLoading) {
    return (
      <div className="w-full h-full min-h-[350px] bg-gray-50 animate-pulse rounded-[10px] flex items-center justify-center shadow-md">
        <svg
  ...
  // Safe index ensures rendering doesn't crash during live updates
