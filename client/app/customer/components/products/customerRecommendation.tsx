  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm font-medium text-gray-500 mb-6">Hand-picked favorites just for you.</p>
      </div>
    
      {isLoading ? (
        <div className="flex items-center justify-center h-64">
          <p className="text-gray-500 font-medium animate-pulse">Loading recommendations...</p>
        </div>
      ) : (
