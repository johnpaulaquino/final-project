  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-[#0B1527]/60 backdrop-blur-sm">
      ...
      <div className="bg-white rounded-3xl w-full max-w-[850px] shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[90vh] relative">
        ...
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 z-20 w-8 h-8 flex items-center justify-center rounded-full bg-white/80 md:bg-gray-100 hover:bg-gray-200 text-gray-600 transition shadow-sm"
        >
        ...
        <div className="relative w-full md:w-[45%] h-[300px] md:h-auto bg-gray-100 flex-shrink-0">
          {/* Using standard <img> to bypass Next.js strict domain rules for quick testing */}
          <img 
        ...
        <div className="w-full md:w-[55%] flex flex-col bg-white h-full max-h-[60vh] md:max-h-[90vh] overflow-y-auto custom-scrollbar">
          <div className="p-6 md:p-8 flex flex-col gap-6">
            ...
            <div>
              <span className="inline-block px-2 py-1 bg-red-50 text-[#800000] text-[10px] font-bold rounded-md mb-3">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              {product.description || 'Indulge in our freshly prepared beverage, crafted with premium ingredients to satisfy your cravings. Perfect for any time of the day.'}
            </p>
            ...
            <div className="flex items-center justify-between bg-[#fcfcfc] border border-gray-100 p-4 rounded-2xl">
              ...
              <button 
                ...
                className="cursor-pointer bg-[#0B1527] hover:bg-gray-800 text-white font-bold py-3 px-6 rounded-xl transition-colors flex items-center gap-2 shadow-md"
              >
