...
export default function ProductModal({
  ...
  // 1. Updated to use product.quantity instead of product.stock
  const isOutOfStock = product.quantity <= 0;

  // 2. Safely grab the first image, or use a placeholder if the array is empty
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 bg-[#0B1527]/60 backdrop-blur-sm">
      ...
      <div className="bg-white rounded-3xl w-full max-w-[850px] shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[90vh] relative">
        ...
        <div className="relative w-full md:w-[45%] h-[300px] md:h-auto bg-gray-100 flex-shrink-0">
          <img
            src={displayImage} // Updated to use the safe image logic
            alt={product.Products.product_name} // Updated to match backend
          ...
          <div className="p-6 md:p-8 flex flex-col gap-6">
            <div>
              ...
              <h2 className="text-3xl font-black text-[#0B1527] leading-tight mb-2">
                {product.Products.product_name} {/* Updated to match backend */}
              </h2>
              <div className="flex items-center gap-2 text-sm">
                ...
                {/* Updated to match avg_rating */}
                <span className="font-bold text-gray-800">
                  {product.avg_rating || "0.0"}
                </span>
                <span className="text-gray-500">(124 reviews)</span>{" "}
                {/* Keep static or wire up if you have review counts */}
              </div>
            </div>
            ...
            {/* If your backend doesn't send nutrition facts, you might want to hide this block entirely or keep the static data as a placeholder */}
            <div>
              <h3 className="font-black text-[#0B1527] mb-3">
                Nutrition Facts
              </h3>
              <div className="grid grid-cols-5 gap-2 border border-gray-100 rounded-xl p-3 bg-white text-center">
                ...
                <div className="flex flex-col border-r border-gray-100">
                  ...
                  <span className="font-bold text-gray-800">5g</span>
                </div>
                <div className="flex flex-col border-r border-gray-100">
                  <span className="text-[9px] font-bold text-gray-400 uppercase">
                    Carbs
                ...
                <div className="flex flex-col border-r border-gray-100">
                  ...
                  <span className="font-bold text-gray-800">2g</span>
                </div>
