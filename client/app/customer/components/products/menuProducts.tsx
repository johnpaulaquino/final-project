...
export default function menuProducts({ product }: { product: Product }) {
  ...
  return (
    <div className={`bg-white rounded-[10px] shadow-sm overflow-hidden hover:shadow-md transition duration-300 cursor-pointer flex flex-col group h-full relative ${isOutOfStock ? 'opacity-75' : ''}`}>
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <div className="flex items-center justify-between mt-auto pt-4">
          <span className={`text-sm font-bold ${isOutOfStock ? 'text-gray-400 line-through' : 'text-[#800000]'}`}>
            ₱{product.price}
          </span>
