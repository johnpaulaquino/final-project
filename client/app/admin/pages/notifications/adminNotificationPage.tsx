...
export default function adminNotificationPage() {
  ...
  // 🚨 ADD THIS TRACKER:
  // This forces the log to run ONLY in the browser, every time the context data changes.
  useEffect(() => {
    console.log("🔥 PAGE DETECTED DATA CHANGE:", notifications);
  }, [notifications]); // <-- This tells React to run this log whenever 'notifications' updates
  // Helper function to convert ISO dates to relative time ("5 mins ago")
      ...
      <div className="flex flex-col gap-4">
        {notifications.length === 0 ? (
          ...
          notifications.map((notif) => (
            ...
            >
              {/* Optional: Indicator dot for unread */}
              {!notif.is_user_read && (
