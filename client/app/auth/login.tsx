...
export default function Login({
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.action === "USER_ACTION_EMAIL_VERIFICATION") {
      ...
      <form className="flex flex-col gap-4" onSubmit={handleLogin}>
        ...
        <div className="flex flex-col">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              disabled={isLoading}
              className="w-full pl-10 pr-4 py-2.5 bg-white text-gray-800 border border-gray-200 rounded-lg focus:outline-none focus:border-[#8a0606] focus:ring-1 focus:ring-[#8a0606] text-sm transition-all placeholder:text-gray-400 disabled:opacity-50"
            />
          </div>
        </div>
        ...
        <div className="flex justify-end">
          <button
            ...
            className="text-xs text-[#8a0606] hover:underline font-semibold"
          >
            Forgot password?
          </button>
        </div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full bg-[#8a0606] hover:bg-[#660000] text-white font-semibold py-2.5 rounded-lg mt-2 transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed"
        >
